...
Last done: redesign DEPLOYED to prod (dpl_5doMWnvDHKaVDUz3LgxYHPEVu5Wk) — smoke 4/4 live, manifest #0b100e + sw v2 confirmed on the wire.

Next: (a) first real /coach run once ~1wk of data; (b) synthesis reminder automation; (c) optional: git remote + Vercel git integration, custom domain. DoD gate unchanged: 4-week capture habit.
